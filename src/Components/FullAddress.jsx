...
const FullAddress = ({ formData, handleChange, errors }) => {
  ...
  return (
    <div>
      ...
      <div className="flex gap-3 w-full max-[1100px]:flex-col items-center max-[1100px]:space-y-4">
      ...
      <div className="flex gap-5 mt-7 w-full py-6 max-[1100px]:flex-col max-[1100px]:space-y-2 max-[1100px]:py-1">
        <div className="w-full relative">
